...
class ConversationContextManager:
    ...
    async def get_optimized_history(self, chat_id: str, memory_engine: Any, limit: int = 10) -> str:
        """
        Fetches history and formats it as "Summary + N Recent Messages".
        Ensures strict character limits per message.
        """
        try:
            # 1. Fetch raw history
    ...
    async def compress_large_context(self, text: str, model_provider: Any, prompt_registry: Any, query: str = "", prompt_key: str = "core.identity.compression") -> str:
